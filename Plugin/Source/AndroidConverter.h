//
// Android-specific DXT to RGBA32 converter for KlakHap
// This enables HAP video playback on Android devices without DXT support
//
#pragma once
...
namespace KlakHap
{
    namespace Android
    {
        ...
        // Check if Android format conversion should be used
